...
from base_win import * #IMPORTING THE MAIN.PY FILE
...
# tab_Buttons = ['bn_text', 'bn_voice', 'bn_image', 'bn_noise'] #BUTTONS IN MAIN TAB  
# android_buttons = ['bn_image_contact', 'bn_image_game', 'bn_image_clean', 'bn_image_world'] #BUTTONS IN ANDROID STACKPAGE
...
class UIFunction(MainWindow):
    ...
    def initStackTab(self):
        global init
        if init==False:
            self.ui.stackedWidget.setCurrentWidget(self.ui.page_TextToSpeech)
            self.ui.lab_tab.setText("Text to Speech")
            self.ui.frame_text.setStyleSheet("background:rgb(91,90,90)")
            init = True
    ################################################################################################
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.ui.bn_max.setIcon(QtGui.QIcon("icons/1x/min.png")) #CHANGE THE MAXIMISE ICON TO RESTOR ICON
    ...
    #ASLO IT SETS THE ABOUT>LEMON4 AS THE FIRST PAGE.
    ...
    def toodleMenu(self, maxWidth, clicked):
        ...
        if clicked:
            ...
            if currentWidth==80:
                ...
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_about_Lemon4)
                self.ui.lab_tab.setText("About > Lemon4")
                self.ui.frame_text.setStyleSheet("background:rgb(91,90,90)")
            else:
                extend = minWidth
    ...
    def buttonPressed(self, buttonName):
        ...
        if buttonName=='bn_text':
            if self.ui.frame_bottom_west.width()==80  and index!=6:
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_TextToSpeech)
                self.ui.lab_tab.setText("Text to Speech")
                self.ui.frame_text.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST 

            elif self.ui.frame_bottom_west.width()==160  and index!=1:  # ABOUT PAGE STACKED WIDGET
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_about_TextToSpeech)
                self.ui.lab_tab.setText("About > Text to Speech")
                self.ui.frame_text.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

        elif buttonName=='bn_voice':
            if self.ui.frame_bottom_west.width()==80 and index!=8:
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_VoiceConversion)
                self.ui.lab_tab.setText("Voice Conversion")
                self.ui.frame_voice.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

            elif self.ui.frame_bottom_west.width()==160 and index!=2:   # ABOUT PAGE STACKED WIDGET
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_about_VoiceConversion)
                self.ui.lab_tab.setText("About > Voice Conversion")
                self.ui.frame_voice.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

        elif buttonName=='bn_image':
            if self.ui.frame_bottom_west.width()==80  and index!=7:
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_ImageRefinement)
                self.ui.lab_tab.setText("Image Refinement")
                self.ui.frame_image.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

            elif self.ui.frame_bottom_west.width()==160  and index!=4:   # ABOUT PAGE STACKED WIDGET
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_about_ImageRefinement)
                self.ui.lab_tab.setText("About > Image Refinement")
                self.ui.frame_image.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

        elif buttonName=='bn_noise':
            if self.ui.frame_bottom_west.width()==80 and index!=5:
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_Denoise)
                self.ui.lab_tab.setText("Audio Denoise")
                self.ui.frame_noise.setStyleSheet("background:rgb(91,90,90)") # SETS THE BACKGROUND OF THE CLICKED BUTTON TO LITER COLOR THAN THE REST

            elif self.ui.frame_bottom_west.width()==160 and index!=3:   # ABOUT PAGE STACKED WIDGET
                self.ui.stackedWidget.setCurrentWidget(self.ui.page_about_Denoise)
    ...
    #----> INITIALIZE THE COMBOBOX SO THAT IT IS UNCLICKABLE UNTIL THE KEY IS TRIGGERED
    def initComboBox(self):
        self.ui.TTS_comboBox_SelectRole.setEnabled(False)
        self.ui.VC_comboBox_SelectRole.setEnabled(False)
    ################################################################################################################################

    #----> CONNECT COMBOBOX WITH THE PUSHBUTTON SIGNAL
    # SET THE ENABLE SIGNAL TO TRUE AFTER CLICKING
    def enableComboBox(self, comboBox):
        # MAKE THE COMBOBOX CONTROL AVAILABLE AFTER CLICKING THE PUSHBUTTON
