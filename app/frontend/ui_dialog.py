...
"}")
        ...
        self.frame_2.setStyleSheet(u"background:qradialgradient(cx:0, cy:0, radius:1, fx:0,fy:0,\n"
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"icons/1x/closeAsset43.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.lab_message.setStyleSheet(u"color:#04130a;")
