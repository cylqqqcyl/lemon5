...
@st.cache_resource
def get_model():
    tokenizer = AutoTokenizer.from_pretrained("/mnt/d/Coding/Projects/ChatGLM2-6B/checkpoints", trust_remote_code=True)
    model = AutoModel.from_pretrained("/mnt/d/Coding/Projects/ChatGLM2-6B/checkpoints", trust_remote_code=True).cuda()
